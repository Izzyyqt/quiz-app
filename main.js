...
const finishSnd = new Audio('finish.mp3');
...
document.getElementById('nextBtn').addEventListener('click', function () {
    ...
    if (currentQuestionIndex < questions.length - 1) {
        ...
        if (!finishSoundPlayed) {
            ...
            finishSnd.play();
            // Set the variable to true to indicate that finishSnd has been played
        ...
        document.getElementById('bottom').style.fontSize = '25px';
        // Remove the timer display
        document.getElementById('timer').style.display = 'none';
        document.getElementById('score').style.display = 'none';

        paragraphElement.textContent = 'Made by Jazperqt';

        bottomElement.appendChild(paragraphElement);
    }
});
